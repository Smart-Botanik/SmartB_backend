...
exports.seedDevPlantEvents = seedDevPlantEvents;
const contracts_1 = require("@growing/contracts");
const SEED_PREFIX = "seed:rew-07";
async function seedDevPlantEvents(prisma) {
    ...
    const existing = await prisma.event.count({
        where: {
            ...
            actionPath: contracts_1.PLANT_HEALTH_ACTION_PATH_STRINGS.resolve,
    ...
    const events = [
        {
            actionPath: contracts_1.PLANT_GROWTH_ACTION_PATH_STRINGS.watering,
        ...
        {
            actionPath: contracts_1.PLANT_HEALTH_ACTION_PATH_STRINGS.treatment,
        ...
        {
            actionPath: contracts_1.PLANT_HEALTH_ACTION_PATH_STRINGS.update,
...
//# sourceMappingURL=seed-dev-plant-events.js.map